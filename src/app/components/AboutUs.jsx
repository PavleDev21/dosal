    ...
    <section id='o-nama' className='pt-20 px-6 xl:p-0 xl:flex xl:h-screen'>
        <div className="text-center flex flex-col items-center relative pb-60 xl:w-[80%] xl:py-20 xl:px-16 2xl:justify-center">
            ...
            <div className="xl:pr-[200px]">
                <p className='mb-3 max-w-[450px] xl:text-left xl:max-w-none xl:self-start'>DOSAL - vaš pouzdani partner za vrhunsku keramiku. Naša firma je osnovana s jasnim ciljem – da na tržište donesemo visokokvalitetne A-klase porcelanske pločice. U našoj ponudi pronaći ćete širok izbor pločica različitih boja, tekstura i formata, savršenih za zidove, podove, kuhinjske radne ploče, stepenice, šankove i stolove.</p>
                <p className='mb-3 max-w-[450px] xl:text-left xl:max-w-none xl:self-start'>Kombinujemo moderan dizajn, luksuz i minimalizam, pružajući kvalitetne i dugotrajne proizvode. Naš cilj je da vaš prostor podignemo na viši nivo.</p>
            </div>
            ...
            <Image
                className='w-[80%] h-[350px] xl:w-[450px] xl:h-[440px] 2xl:h-[650px] max-h-[80%] absolute z-10 -bottom-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 xl:bottom-1/2 xl:right-0 xl:translate-y-1/2'
